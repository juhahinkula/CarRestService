...
public class CarstockApplication {
	...
	public CommandLineRunner demo(CarRepository repository) {
		return (args) -> {
			...
			repository.save(new Car("Mazda", "6", "Red", "A95", 2018));
			...
			repository.save(new Car("Tesla", "Model X", "Silver", "Electric", 2017));
			...
			repository.save(new Car("Volvo", "XC60", "Black", "A95", 2015));
